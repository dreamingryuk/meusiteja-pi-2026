  ...
  return (
    <div className="min-h-screen bg-gray-200 py-6 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {/* =====================================================
            BOTÕES DA VISUALIZAÇÃO PÚBLICA
        ====================================================== */}
        {isPublicView && (
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleChange('sobre', e.target.value)
                }
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('tecnicas', e.target.value)
                  }
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange('pessoais', e.target.value)
                  }
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 outline-none"
                  ...
                  (exp, index) => (
                    ...
                    >
                      ...
                      <textarea
                        ...
                        className="w-full border border-gray-200 rounded-lg px-3 py-1.5 text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-y"
                        rows="2"
                      ...
                      <button
                        ...
                        onClick={() =>
                          setEditData((previousData) => ({
                            ...previousData,
                            experiencias:
                              previousData.experiencias.filter(
                                (_, i) => i !== index
                              )
                          }))
                        }
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <input
                    type="color"
                    value={
                      editData.cor_secundaria || '#1E40AF'
                    }
                    onChange={(e) =>
                      handleChange(
                        'cor_secundaria',
            ...
            <p className="text-xs text-gray-400 pt-2">
              ✨ As alterações são salvas ao clicar em
              "Publicar Site".
            </p>
